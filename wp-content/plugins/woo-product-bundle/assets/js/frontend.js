...
function woosb_check_ready($wrap) {
    ...
    if (is_selection || is_empty || is_min || is_max) {
        ...
        if (is_selection) {
            ...
            $alert.html(
                woosb_vars.alert_min.replace('[min]', $products.attr('data-min')).replace('[selected]', total)).slideDown();
        } else if (is_max) {
            $alert.html(
                woosb_vars.alert_max.replace('[max]', $products.attr('data-max')).replace('[selected]', total)).slideDown();
        }
